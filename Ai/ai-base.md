...
Ai(Artificial Intelligence in Singapore 人工智能)

## 大模型

[Ai 模型排行](https://artificialanalysis.ai/)
...
- [GLM](https://chat.z.ai/)
- [MinMax](https://agent.minimax.io/)
- [Kimi](https://www.kimi.com/)
- [Qwen](https://qwen.ai)

## 名词

LLM: Large Language Model 大语言模型, 使用大量文本训练的深度学习模型, 训练参数量级通常在百亿以上
